...
**AM_PEM_TRUSTSTORE**: System CA bundle.
**AM_PEM_TRUSTSTORE_EXTRA**: Custom user supplied certificates to append to the truststore.  
...
```bash
kubectl --namespace *mynamespace* create secret generic platform-truststore-certificates --from-file=certificates=/path/to/my/certificates
```
