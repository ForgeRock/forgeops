...
export const enableNginxIngress = config.getBoolean("enableNginxIngress") || false;
// ** CLUSTER CONFIG **
...
// ** NODE POOL CONFIG **
export const nodeCount = config.getNumber("initialNodeCount") || 1;
...
export let minNodes = config.getNumber("min") || 1;
...
// Optional components
export const enableCertManager = config.getBoolean("enableCertManager") || false;
