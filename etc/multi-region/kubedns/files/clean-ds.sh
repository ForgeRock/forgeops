...
# Multi-region DS: script to clean DS CTS and DS IDREPO from US and Europe clusters
...
kubectx $US_CONTEXT
kubens $NAMESPACE
skaffold delete --profile multi-region-ds-us
...
kubens $NAMESPACE
skaffold delete --profile multi-region-ds-eu
kubectl delete pvc data-ds-idrepo-0
kubectl delete pvc data-ds-idrepo-1
kubectl delete pvc data-ds-cts-0
kubectl delete pvc data-ds-cts-1
