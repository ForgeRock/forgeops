...
mkdir -p $dir
cd $dir
charts="opendj amster openam openidm openig postgres-openidm frcommon git opendj-cluster cmp-idm-dj-postgres cmp-am-dj cmp-am-dev cmp-platform cmp-am-embedded"
for chart in $charts
do
