...
helm upgrade -i ${NAMESPACE}-kube-prometheus coreos/kube-prometheus --set=rbac.install=true -f values/kube-prometheus.yaml,values/fr-alerts.yaml --namespace=$NAMESPACE
