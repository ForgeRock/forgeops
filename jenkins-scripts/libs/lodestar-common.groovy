...
ArrayList postcommitMandatoryStages(boolean enabled) {
    return [
        ...
        booleanParam(name: 'Postcommit_fo_acceptance', defaultValue: false), // Disable all the Guillotine tests
        booleanParam(name: 'Postcommit_fo_smoke_small', defaultValue: false),
        booleanParam(name: 'Postcommit_fo_set_images', defaultValue: false),
        booleanParam(name: 'Postcommit_fo_dsbackup', defaultValue: false),
