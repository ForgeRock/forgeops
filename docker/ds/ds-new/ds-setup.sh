...
cat ldif-ext/external-am-datastore.ldif ldif-ext/uma/*.ldif ldif-ext/alpha_bravo.ldif ldif-ext/NBdigital_NBintern.ldif ldif-ext/sunamhiddenrealmdelegationservicepermission.ldif >> template/setup-profiles/AM/config/6.5/base-entries.ldif
