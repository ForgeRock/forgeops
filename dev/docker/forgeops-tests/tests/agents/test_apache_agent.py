...
# Framework imports
from ProductConfig import ApacheAgentConfig, AMConfig
from agent_utils import process_autosubmit_form
from utils import logger, rest


class TestApacheAgent(object):
    ...
    def test_access_allowed_resource(self):
        ...
        current_session.headers = {'X-OpenAM-Username': 'testuser-apache', 'X-OpenAM-Password': 'password',
